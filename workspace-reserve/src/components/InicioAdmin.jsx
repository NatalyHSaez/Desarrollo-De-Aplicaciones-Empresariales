...
import Oficinas from "./Oficinas"; // ✅ Importar Oficinas
...
import oficinasData from "../data/oficinas"; // ✅ Traer datos de oficinas
  ...
  return (
    <div className="min-h-screen bg-gray-100">
      ...
      <div className="lg:col-span-2">
          ...
          <Oficinas
            oficinas={oficinasData}  // Pasando las oficinas a la grilla
          />
